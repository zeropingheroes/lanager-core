...
**Please note:** This repository (`zeropingheroes/lanager-core`) is the core project version, and doesn't include or track the install version. All forks, issues and pull requests relevant to the install version and not core functionality should be submitted to [`zeropingheroes/lanager`](https://github.com/zeropingheroes/lanager).
