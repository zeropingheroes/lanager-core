...
<div class="user_show_header">
	...
	<ul class="user_show_tools">
		<li><a href="{{ SteamBrowserProtocol::getAddFriendLink($user->steam_id_64) }}">Add</a></li>
		<li><a href="{{ SteamBrowserProtocol::getSendMessageLink($user->steam_id_64) }}">Message</a></li>
